    ...
    implements TranscriptionService
{
    ...
    public final static String DEFAULT_FEATURES
            = "model=enhanced&punctuate=true&interim_results=true";
        ...
        implements StreamingRecognitionSession
    {
        ...
        /* Spoken language of the user who requested the transcription */
        private String spokenLanguage = "en";
        ...
        void connect(TranscriptionRequest request)
        {
            ...
            try
            {
                ...
                parts.add("language=" + spokenLanguage);
